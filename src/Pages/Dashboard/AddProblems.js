...
const AddProblems = () => {
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://still-sea-84749.herokuapp.com/studentsProblems', {
                        method: 'POST',
                        headers: {
    ...
    return (
        <div className='p-5'>
            <h2 style={{ fontFamily: 'Merienda' }} className='text-center font-bold text-2xl pb-4'>Add Problems</h2>
            <div className='bg-primary p-5 py-8 rounded w-full md:w-8/12 mx-auto'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="pb-4 block md:flex items-center">
                        <label style={{ fontFamily: 'Merienda' }} className='w-full md:w-3/12 font-bold text-white' htmlFor="education">Roll</label>
                        <input className='w-full md:w-9/12 bg-slate-200 p-2 lg:max-w-lg rounded-sm' type="text" {...register("roll", { required: true })} />
                    </div>
                    <div className="pb-4 block md:flex items-center">
                    ...
                    <div className='flex items-center justify-center'>
                        <button type="submit" className='btn bg-primary text-white'>Add Problem</button>
                    </div>
                </form>
            </div>
        </div>
