...
const PrincipleMessage = () => {
    return (
        <div className='w-full lg:w-11/12 px-4 lg:px-6 mx-auto py-8'>
            <h2 className='text-2xl font-bold py-1'>Mr.Abdul Kuddus</h2>
            <h4 className='text-lg'>Principle of Katirhat High School</h4>
            ...
            <div className='py-4'>
                ...
                <p className='text-lg pt-3'> We welcome all the students at our beautiful campus to have a chance to enrich academically. As our institution is situated at Dhaka Cantonment, students are safe and secure here. We understand every student is unique at their own way and we are earnestly ready to find out their latent talent.
